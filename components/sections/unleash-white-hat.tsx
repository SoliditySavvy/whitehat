...
export const Clients = () => (
  <>
    <p className="mb-12 text-center text-lg text-white md:text-xl">
      ...
      Empowering the world's top-notch clients
      </span>
      <br className="hidden md:block" /> From innovative startups on the cutting edge of technology to well-established enterprises with a rich history of success, we're the trusted choice for organizations worldwide.
    </p>
